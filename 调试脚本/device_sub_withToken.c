...
void mqtt_task(void *arg)
{
    ...
    init.clientId = "d:changhongDevice_Sub";
    init.host = "mqtt.mymlsoft.com";
    init.port = 1883;
    init.keepAliveInterval = 10;
    init.logout = simple_log;
    init.username = "changhongDevice_Sub";
    init.password = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJ0YW8xLmppYW5nIiwidXNlciI6ImNoYW5naG9uZ0RldmljZV9TdWIifQ.jtJc3mbEGOHIb-6zJV4hJ7JqlngVvYKV9KfymMg6qUo";

...
def connect_broker(client):
	...
	client.username_pw_set("D006888999-00001-000001", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.ImFhYSI.K0oDWBoeLhnYMe5QrA5wLaVynQKnfIeX3Q1jA5tR_lU")	#Connect with Username / Password
...
if __name__ == "__main__":
	for loop in range(1,101):
		client = mqtt.Client(client_id="d:D006888999-00001-000001", clean_session=True, userdata=None, protocol=mqtt.MQTTv31)	

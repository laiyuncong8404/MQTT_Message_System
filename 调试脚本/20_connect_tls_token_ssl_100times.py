...
# broker_address = "mqtt.homwee.cn" #虹微DNS解析服务器
broker_port = 1883
global msg_total
msg_total = 1
...
def connect_broker(client):
	...
	client.username_pw_set("D3A6004707LMTE1711210001", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.ImFhYSI.K0oDWBoeLhnYMe5QrA5wLaVynQKnfIeX3Q1jA5tR_lU")	#Connect with Username / Password
...
if __name__ == "__main__":
	for loop in range(1,101):
		client = mqtt.Client(client_id="d:D3A6004707LMTE1711210001", clean_session=True, userdata=None, protocol=mqtt.MQTTv31)	
...
#disconnect
		...
		print '******Success, connect cost %ss, disconnect cost %ss,total %d times.******' % (connect_time, disconnect_time, loop)
